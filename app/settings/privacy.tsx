        ...
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="p-6">
                <View className="items-center mb-8">
                    ...
                    <Text className="text-gray-900 font-bold text-xl mt-4 text-center">Your Privacy Matters</Text>
                </View>
                ...
                <View className="mt-12 mb-8 items-center">
                    <Text className="text-gray-400 text-xs">Last Updated: January 2026</Text>
                </View>
            </ScrollView>
        </View>
    );
