...
const ARTICLES = {
    "track-order": {
        ...
        content: "Once your order has been shipped, you will receive an email with a tracking number. You can use this number on our website or app to see the real-time status of your delivery.\n\nSteps to track:\n1. Open your Profile.\n2. Go to 'Orders'.\n3. Tap on the order you want to track.\n4. Click 'Track Shipment'."
    },
    "returns": {
        title: "Return and Refund Policy",
        content: "We offer a 30-day return policy for most items. If you are not satisfied with your purchase, you can return it for a full refund or exchange.\n\nConditions:\n- Item must be in original condition.\n- Original packaging must be included.\n- Proof of purchase is required."
    },
    "account": {
        title: "Changing account information",
        content: "Upading your personal information is easy. Go to 'Settings' and select 'Edit Profile'. From there, you can change your name, email, and bio.\n\nTo change your password, go to 'Settings' -> 'Change Password'."
    },
    "payment": {
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="p-6">
                <Text className="text-2xl font-bold text-gray-900 mb-6">{article.title}</Text>
                <Text className="text-gray-700 leading-7 text-lg">
                    {article.content}
                </Text>

                <View className="mt-12 pt-8 border-t border-gray-100">
                    <Text className="text-gray-900 font-bold mb-4">Was this article helpful?</Text>
