...
export default function EditProfile() {
    ...
    const [bio, setBio] = useState("Passionate about modern interior design and minimalist furniture.");
        ...
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="p-4">
                ...
                <View className="items-center my-8">
                    ...
                    <Text className="text-blue-500 font-semibold mt-4">Change Profile Picture</Text>
                </View>
