        ...
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="p-6">
                <View className="items-center mb-8">
                    ...
                    <Text className="text-gray-900 font-bold text-xl mt-4">Send us an email</Text>
                    <Text className="text-gray-500 text-center mt-2">We'll get back to you within 24 hours</Text>
                </View>
...
function InputField({ label, value, onChangeText, placeholder, ...props }: any) {
    return (
        <View className="mb-4">
            <Text className="text-gray-500 font-bold text-xs uppercase mb-2 ml-1">{label}</Text>
